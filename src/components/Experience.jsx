  ...
  const experiences = [
    {
      ...
      description: [
        "Focused on full-stack web development, actively building scalable applications and features."
      ],
      skills: ["HTML5", "Express.js", "+8 skills"],
    ...
    },
    {
      ...
      company: "Akestech Infotech Private Limited",
      type: "Full-time",
      date: "Jan 2025 - Apr 2025",
      duration: "4 mos",
      location: "Noida, Uttar Pradesh, India · Remote",
      description: [
        "Developed interactive user interfaces using ReactJS, Tailwind CSS, and Material UI for Tattva Technology.",
        "Explored backend technologies like NodeJS and ExpressJS, integrating MongoDB for database management."
      ],
      skills: ["React.js", "Node.js", "+2 skills"],
    ...
    },
    {
      ...
      location: "Remote",
      description: [
        "Assisted in full-stack development tasks, learning and applying modern web technologies."
      ],
      skills: ["HTML5", "CSS", "+5 skills"],
        ...
        <div className="mb-20 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 w-max backdrop-blur-sm mb-6 mx-auto md:mx-0">
              ...
              <span className="text-xs font-semibold tracking-wider text-white/80 uppercase">Journey So Far</span>
            </div>
                ...
                <div className="flex flex-col gap-5 relative z-10">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-xs font-semibold tracking-wide text-white/40 mb-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>{exp.date} <span className="text-[var(--accent)]">·</span> {exp.duration}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                  ...
                  <ul className="space-y-3 mb-2">
                    {exp.description.map((desc, i) => (
                      <li key={i} className="text-white/60 text-sm leading-relaxed flex items-start gap-3">
                        <span className="text-[var(--accent)] mt-1 shrink-0 opacity-80">▹</span>
                        <p>{desc}</p>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div className="pt-5 border-t border-white/5 mt-2">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Skills & Tech Stack</span>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {exp.skills.map((skill, i) => (
                        <span key={i} className="px-3 py-1.5 text-xs font-medium text-white/70 bg-white/5 rounded-md border border-white/5 group-hover:border-[var(--accent)]/20 group-hover:bg-[var(--accent)]/5 transition-colors duration-300">
                          {skill}
                        </span>
                      ))}
                    </div>
