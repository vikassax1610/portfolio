...
const SkillCarousel = () => {
  ...
  const icons = [
    { icon: html, color: "hover:border-red-500", shadow: "hover:shadow-red-500/50" },
    { icon: css, color: "hover:border-blue-500", shadow: "hover:shadow-blue-500/50" },
    { icon: js, color: "hover:border-yellow-500", shadow: "hover:shadow-yellow-500/50" },
    { icon: react, color: "hover:border-blue-500", shadow: "hover:shadow-blue-500/50" },
    { icon: node, color: "hover:border-green-500", shadow: "hover:shadow-green-500/50" },
    { icon: express, color: "hover:border-yellow-500", shadow: "hover:shadow-yellow-500/50" },
    { icon: mongo, color: "hover:border-green-500", shadow: "hover:shadow-green-500/50" },
  ];
  const icons2 = [
    { icon: html, color: "hover:border-red-500", shadow: "hover:shadow-red-500/50" },
    { icon: css, color: "hover:border-blue-500", shadow: "hover:shadow-blue-500/50" },
