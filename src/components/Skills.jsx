...
const otherSkills = [
  "Framer Motion", "Tailwind CSS", "REST APIs", "Git & GitHub",
  "Figma", "Vite", "Redux", "Postman", "Netlify", "Vercel",
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p className="text-white/40 text-lg max-w-sm leading-relaxed">
              A constantly evolving stack — built through real projects, not just tutorials.
            </p>
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                <div
                  ...
                  style={{ background: `linear-gradient(to bottom, ${cat.color}, ${cat.color}33)` }}
                />
                <h3 className="text-2xl font-bold tracking-tight" style={{ color: cat.color }}>
                  {cat.category}
                </h3>
              </div>
        ...
        >
          {[
            ...
            >
              ...
              <p className="text-[11px] uppercase tracking-widest text-white/40 font-semibold">{s.label}</p>
            </div>
          ))}
        </motion.div>
